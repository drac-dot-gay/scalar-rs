...
use surrealdb::types::{Array, Bytes, Decimal, Number, Object, SerializationError, Value};

use crate::serde_wrapper::WrappedError;

pub struct Serializer;

impl serde::ser::Error for WrappedError {
...
impl serde::ser::SerializeStructVariant for SerializeStructVariant {
    ...
    {
        self.map
            .insert(String::from(key), value.serialize(Serializer)?);
        Ok(())
    }
